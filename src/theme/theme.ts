...
/**
 * Акцентные цвета, снятые с логотипа «Земляк» (лист, лента поля, солнце).
 * Не входят в роли MD3 — используются только точечно, для декоративных
 * бейджей на онбординге, чтобы не размывать пшенично-кофейную палитру ролей.
 */
export const logoAccents = {
  leaf: '#326D3F',
  leafDark: '#1B3B22',
  ribbon: '#459478',
  sun: '#EA9546',
