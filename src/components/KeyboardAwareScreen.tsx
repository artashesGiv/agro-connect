...
type FocusHandler = (view: View | null) => void;
...
export function KeyboardAwareScreen({
  ...
  return (
    <SafeAreaView edges={edges} style={[styles.container, style]}>
      <View ref={scrollViewRef} style={styles.container} onLayout={measureViewport}>
        <FieldFocusContext.Provider value={handleFieldFocus}>
          ...
          >
            ...
            */}
            <View style={{ height: keyboardInset > 0 ? keyboardInset + visibleHeight / 2 : 0 }} />
          </ScrollView>
